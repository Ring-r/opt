...
namespace Opt.Geometrics
{
    ...
    /// </summary>
    [Serializable]
    public class GeometricsWithList<ElementType> : GeometricWithPole, IGeometricWithList<ElementType>
        where ElementType : class
    {
        ...
        /// </summary>
        protected List<ElementType> list_elements;
        #endregion
        ...
        #region GeometricsWithList(...)
        /// <summary>
        /// Конструктор.
        /// </summary>
        public GeometricsWithList()
        {
            list_elements = new List<ElementType>();
        }
        #endregion
