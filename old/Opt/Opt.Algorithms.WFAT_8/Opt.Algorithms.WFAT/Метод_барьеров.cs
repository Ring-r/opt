    ...
    public class PlacingAll : Placing
    {
        ...
        protected double ValueG(double[] G, double[] X)
        {
            ...
            if (j >= 0)
            {
                ...
                double r = circles[i].Radius + circles[j].Radius - 2 * e;
                //return x * x + y * y - r * r;
    ...
    public class PlacingOpt : Placing
    {
        ...
        protected override double ValueGsWithCheck(double[] X)
        {
            ...
            for (int i = 0; i < circles.Length; i++)
            {
                ...
                value = X[2 * i] - circles[i].Radius + e;
                if (value > 0)
                    res += 1 / value;
                else
                    return double.PositiveInfinity;
                ...
                value = X[2 * i + 1] - circles[i].Radius + e;
                if (value > 0)
                    res += 1 / value;
                else
                    return double.PositiveInfinity;
                ...
                value = -X[2 * i + 1] - circles[i].Radius + height + e;
                if (value > 0)
                    res += 1 / value;
                else
                    return double.PositiveInfinity;
                ...
                value = -X[2 * i] - circles[i].Radius + X[index_strip] + e;
                if (value > 0)
                    res += 1 / value;
                else
                    return double.PositiveInfinity;
                ...
                for (int k = 0; k < 3; k++)
                {
                    if (vertex.Cros.Somes.LastChecked != data)
                    {
                        ...
                        if ((vertex.Next.DataInVertex is Circle) && (vertex.Prev.DataInVertex is Circle))
                        {
                            ...
                            double r = circles[j].Radius + circles[i].Radius - 2 * e;
                            value = Math.Sqrt(x * x + y * y) - r;
                            if (value > 0)
                                res += 1 / value;
                            else
