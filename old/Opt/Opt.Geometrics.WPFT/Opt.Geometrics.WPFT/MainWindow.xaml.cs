...
namespace Opt.Geometrics.WPFT
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            polygon.Pole.Copy = new Point { X = 150, Y = 50 };
            ...
            polygon.Add(new Point { X = 0, Y = 0 });
            polygon.Add(new Point { X = 100, Y = 100 });
            polygon.Add(new Point { X = 0, Y = 100 });
            polygons.List.Add(polygon);

            polygon = new PolygonShell();
            polygon.Pole.Copy = new Point { X = 400, Y = 80 };
            polygon.Add(new Point { X = 0, Y = 0 });
            polygon.Add(new Point { X = 100, Y = 0 });
            polygon.Add(new Point { X = 100, Y = 100 });
            polygons.List.Add(polygon);
        ...
        {
            List<Polygon> polygons = new List<Polygon>(this.polygons.List);
    ...
    public class PolygonShell : Polygon, IEnumerable, INotifyCollectionChanged
    {
        /// <summary>
