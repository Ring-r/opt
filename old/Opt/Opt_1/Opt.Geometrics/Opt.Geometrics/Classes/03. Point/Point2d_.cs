...
{
    /// <summary>
    /// Точка-класс в двухмерном пространстве (альтернативный вариант).
    /// </summary>
    [Serializable]
    public class Point2d : Opt.Geometrics.Geometric2d
    {
        ...
        /// </summary>
        /// <param name="point">Точка (изменяется).</param>
        ...
        {
            return point_this.vector.Copy - point.vector;
        }
        #endregion
