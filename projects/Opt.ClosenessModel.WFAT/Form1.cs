    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (k > -1)
            {
                ...
                do
                {
                    double ed = GeometricExt.Расширенное_расстояние(circle, vertex_temp.DataInVertex as Geometric2d);
                    if (radius_max > ed)
                        radius_max = ed;
        ...
        {
            if (vertex != null)
                vertexes = VertexExtention.Близжайшая_тройка(vertex, new Circle() { Pole = new Point2d() { X = e.X, Y = e.Y } }, true);
