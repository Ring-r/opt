...
namespace Opt.Geometrics.Geometrics2d.Extentions
{
    ...
    /// </summary>
    public static class Plane2dExt
    {
        ...
        public static Point2d Точка_пересечения_границ(Plane2d plane_prev, Geometric2dWithPointScalar circle_next)
        {
            ...
            double c = vector * vector - circle_next.Scalar * circle_next.Scalar;
            double d = b * b - c;
            if (d < 0)
                return null;
            else
        ...
        public static Plane2d Серединная_полуплоскость(Plane2d plane_prev, Geometric2dWithPointScalar circle_next)
        {
