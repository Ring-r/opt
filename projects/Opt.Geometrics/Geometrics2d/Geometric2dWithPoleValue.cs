...
namespace Opt.Geometrics.Geometrics2d
{
    ...
    /// </summary>
    [Serializable]
    public class Geometric2dWithPoleValue : Geometric2dWithPole
    {
        ...
        /// </summary>
        public Geometric2dWithPoleValue Copy
        {
            get
            {
                return new Geometric2dWithPoleValue() { value = this.value, pole = this.pole.Copy };
            }
            set
            {
