...
namespace Opt.Geometrics.SpecialGeometrics
{
    ...
    public class PlaneDividing
    {
        ...
        protected Polygon2d.Iterator iterator_plane;
        protected Polygon2d.Iterator iterator_point;
        #endregion

        #region Открытые поля и свойства.
        public Polygon2d.Iterator IteratorPlane
        {
            get
            {
        ...
        public Polygon2d.Iterator IteratorPoint
        {
            get
            {
